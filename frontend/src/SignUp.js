...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // 성공적으로 회원가입이 되었다고 가정하고 setSignupSuccess(true) 호출

    setSignupSuccess(true); // 회원가입 성공 시에만 호출
  ...
  const handleCheckIdAvailability = () => {
    ...
    // 아이디가 중복되지 않으면 setIsIdAvailable(true) 호출
    // 아이디가 중복되면 setIsIdAvailable(false) 호출

    setIsIdAvailable(true); // 중복되지 않을 때 호출
    // setIsIdAvailable(false); // 중복될 때 호출
  };
          ...
          {signupSuccess ? (
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group controlId="formBasicUsername">
                <Form.Label style={{ fontSize: '15px' }}>아이디</Form.Label>
                <Row>
                  <Col md={8}>
                ...
                {!isIdAvailable && (
                  <div className="text-danger">이미 사용 중인 아이디입니다.</div>
                )}
              </Form.Group>

              <Form.Group controlId="formBasicName">
                <Form.Label style={{ fontSize: '15px', textAlign: 'right' }}>이름</Form.Label>
                <Form.Control type="text" placeholder="이름을 입력하세요" required />
              </Form.Group>

              <Form.Group controlId="formBasicNickname">
                <Form.Label style={{ fontSize: '15px' }}>닉네임</Form.Label>
                <Form.Control type="text" placeholder="닉네임을 입력하세요" required />
              </Form.Group>

              <Form.Group controlId="formBasicPassword">
                <Form.Label style={{ fontSize: '15px' }}>비밀번호</Form.Label>
                <Form.Control type="password" placeholder="비밀번호를 입력하세요" required />
              </Form.Group>

              <Form.Group controlId="formBasicPassword2">
                <Form.Label style={{ fontSize: '15px' }}>비밀번호 확인</Form.Label>
                <Form.Control type="password" placeholder="비밀번호를 한번 더 입력하세요" required />
              </Form.Group>

              <Form.Group controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '15px' }}>이메일 주소</Form.Label>
                <Form.Control type="email" placeholder="이메일을 입력하세요" required />
